# Install script for directory: /jwd/HEPfit/InputParser
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "header" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include/HEPfit" TYPE FILE FILES
    "/jwd/HEPfit/InputParser/src/InputParser.h"
    "/jwd/HEPfit/InputParser/src/ModelFactory.h"
    "/jwd/HEPfit/InputParser/src/ThObsFactory.h"
    )
endif()
...
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/jwd/HEPfit/build/InputParser/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
